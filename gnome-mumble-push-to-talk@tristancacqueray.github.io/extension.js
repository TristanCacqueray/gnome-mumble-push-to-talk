...
})(PS["Shell.ActionMode"] = PS["Shell.ActionMode"] || {});
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["Shell.ActionMode"] = $PS["Shell.ActionMode"] || {};
  var exports = $PS["Shell.ActionMode"];
  var $foreign = $PS["Shell.ActionMode"];
...
})(PS["ShellUI.Main.WM"] = PS["ShellUI.Main.WM"] || {});
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["ShellUI.Main.WM"] = $PS["ShellUI.Main.WM"] || {};
  var exports = $PS["ShellUI.Main.WM"];
  var $foreign = $PS["ShellUI.Main.WM"];
...
(function($PS) {
  ...
  var Shell_ActionMode = $PS["Shell.ActionMode"];
  var ShellUI_Main_Panel = $PS["ShellUI.Main.Panel"];
  var ShellUI_Main_WM = $PS["ShellUI.Main.WM"];
  ...
  var enable = function (envRef) {
      ...
      return function __do() {
          ...
          Data_Functor["void"](Effect.functorEffect)(Clutter_Actor.onButtonReleaseEvent()(env.button)(onClick(onTalkEnd)(env)))();
          var stateRef = Effect_Ref["new"](false)();
          return Data_Functor["void"](Effect.functorEffect)(ShellUI_Main_WM.addKeybinding("toggle-mumble")(env.settings)(Meta_KeyBindingFlags.ignore_autorepeat)(Shell_ActionMode.all)(onKeyBinding(env)(stateRef)))();
      };
  };
  ...
  var disable = function (envRef) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at GnomeMumblePushToTalk (line 104, column 3 - line 106, column 34): " + [ envM.constructor.name ]);
          })();
          return ShellUI_Main_WM.removeKeybinding("toggle-mumble")();
      };
  };
