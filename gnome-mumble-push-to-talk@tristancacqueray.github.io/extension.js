...
(function($PS) {
  ...
  var enable = function (envRef) {
      ...
      return function __do() {
          ...
          enableTopMenu(env)();
          return enableShortCut(env)();
      };
  };
  var disable = function (envRef) {
      var disableTopMenu = function __do() {
          ...
          throw new Error("Failed pattern match at GnomeMumblePushToTalk (line 116, column 5 - line 118, column 36): " + [ envM.constructor.name ]);
      };
      var disableShortCut = ShellUI_Main_WM.removeKeybinding("toggle-mumble");
      return function __do() {
          log("disable called")();
          disableTopMenu();
