...
(function($PS) {
  ...
  exports["new_now_utc"] = $foreign.new_now_utc;
  exports["difference"] = $foreign.difference;
})(PS);
(function(exports) {
  "use strict";
...
(function(exports) {
  ...
  exports.none = imports.gi.Meta.KeyBindingFlags.NONE
...
(function($PS) {
  ...
  var enable = function (settings) {
      ...
      var onKeyBinding = function (env) {
          return function (timerRef) {
              var releasePushToTalk = function __do() {
                  onTalkEnd(env)();
                  Effect_Ref.write(Data_Maybe.Nothing.value)(timerRef)();
                  return false;
              };
              var startCanceller = function (now) {
                  return function __do() {
                      var timer = GLib.timeoutAdd(500)(releasePushToTalk)();
                      return Effect_Ref.write(Data_Maybe.Just.create(new Data_Tuple.Tuple(now, timer)))(timerRef)();
                  };
              };
              return function __do() {
                  var timerM = Effect_Ref.read(timerRef)();
                  (function () {
                      if (timerM instanceof Data_Maybe.Just) {
                          var now = GLib_DateTime.new_now_utc();
                          var v = GLib_DateTime.difference(now)(timerM.value0.value0);
                          return Control_Applicative.when(Effect.applicativeEffect)(v >= 400000)(function __do() {
                              GLib.sourceRemove(timerM.value0.value1)();
      ...
      var enableShortCut = function (env) {
          return function __do() {
              var timerRef = Effect_Ref["new"](Data_Maybe.Nothing.value)();
              return Data_Functor["void"](Effect.functorEffect)(Gnome_UI_Main_WM.addKeybinding("toggle-mumble")(settings)(Meta_KeyBindingFlags.none)(Gnome_Shell_ActionMode.all)(onKeyBinding(env)(timerRef)))();
          };
      };
