...
(function($PS) {
  ...
  var init = function (env) {
      return GJS.log("gnome-mumble-push-to-talk init called");
  };
  var enable = function (env) {
      return GJS.log("gnome-mumble-push-to-talk enable called");
  };
  var disable = function (env) {
      return GJS.log("gnome-mumble-push-to-talk disable called");
  };
  var create = Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
